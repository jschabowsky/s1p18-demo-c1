...
@EnableConfigurationProperties(UtahInventoryLookupProcessorProperties.class)
public class UtahInventoryLookupProcessorConfiguration {
	@Autowired
	private UtahInventoryLookupProcessorProperties properties;
	
	@Autowired
    private BinderAwareChannelResolver resolver;
	
    private static final Logger log = LoggerFactory.getLogger(UtahInventoryLookupProcessorConfiguration.class);	
